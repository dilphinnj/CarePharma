...
<table width="800" align="center" cellpadding="0" cellspacing="0" class="backg">
  ...
  <tr bgcolor="#000000" style="text-align: center; font-family: 'Palatino Linotype', 'Book Antiqua', Palatino, serif;">
    <td width="173" height="39" valign="top"><a href="home.jsp" style="font-family: 'Palatino Linotype', 'Book Antiqua', Palatino, serif">Home</a></td>
    <td width="294" valign="top"><a href="aboutUs.jsp" style="font-family: 'Palatino Linotype', 'Book Antiqua', Palatino, serif">About Us</a></td>
