...
public final class addCusOrderForm2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</head>\r\n");
      out.write("<script>\r\n");
      out.write("  function createDate()\r\n");
      out.write("{\r\n");
      out.write("    var d2 = new Date();\r\n");
      out.write("    var x2 = d2.getFullYear()+\"-0\"+ d2.getMonth()+\"-\"+ d2.getDate();\r\n");
      out.write("    formAddCust.txtOD.value = x2;\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("\r\n");
...
int noOfMeds = Integer.parseInt(request.getParameter("txtMedNo"));
      ...
      out.write("   \r\n");
      out.write("    \r\n");
      out.write("<body onload=\"createDate()\">\r\n");
      out.write("    \r\n");
      ...
      out.write("    <td width=\"791\" height=\"286\">\r\n");
      out.write("        <form id=\"formAddCust\" name=\"formOrdCust\" method=\"post\" action=\"createInvoice.jsp\" >\r\n");
      out.write("         \r\n");
      ...
      out.write("            <input name=\"txtOD\" type=\"text\" id=\"txtOD\" size=\"50px\" maxlength=\"10\" style=\"width:150px\"  /></td>\r\n");
      out.write("        </tr>\r\n");
      out.write("        <tr>\r\n");
      ...
      out.write("          <td height=\"80\" align=\"center\" bgcolor=\"#999999\"><label for=\"txtTel\"></label>\r\n");
      out.write("            <input name=\"txtMedNo\" type=\"text\" id=\"txtMedNo\" style=\"width:150px\" size=\"50px\" maxlength=\"8\" value=\"");
      out.print(noOfMeds);
      out.write("\" /></td>\r\n");
      out.write("        </tr>\r\n");
      out.write("        \r\n");
      ...
      out.write("            <select name=\"drugList");
      out.print(k);
      out.write("\" id=\"drugListID");
      out.print(k);
 ...
 for(int j=0; j < drugID.size(); j++)
      ...
      out.write("          <td height=\"80\" align=\"center\" bgcolor=\"#999999\"><input name=\"txtQty");
      out.print(k);
      out.write("\" type=\"number\" id=\"txtQty");
      out.print(k);
      out.write("\" min=\"0\" size=\"50px\"  maxlength=\"5\" style=\" width:150px\" /></td>\r\n");
      out.write("        </tr>\r\n");
      out.write("        ");
      ...
      out.write("          <td height=\"60\" align=\"left\" bgcolor=\"#46413C\">\r\n");
      out.write("              <input type=\"submit\" name=\"btnAddCust\" id=\"btnAddCust\" value=\"Add Record\" style=\"width:100px; height:40px; margin-left:150px \" />\r\n");
      out.write("              \r\n");
      out.write("              <input type=\"reset\" name=\"btnCls\" id=\"btnCls\" value=\"Clear\"style=\"width:100px; height:40px; margin-left:30px \" />\r\n");
      out.write("          </td>\r\n");
      out.write("        </tr>\r\n");
      out.write("      </table>\r\n");
      out.write("    </form></td>\r\n");
